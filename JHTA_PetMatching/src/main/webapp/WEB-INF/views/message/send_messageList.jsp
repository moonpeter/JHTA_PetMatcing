...
<div class="container">
  ...
  <span id="title">보낸 메시지함</span><br><br><br>
  <form action="sendMessageList" >
    <div class="input-group">
      ...
      <input name="search_word" type="text" class="form-control"
              placeholder="받는이의 id를 입력하세요." value="${search_word}">
  ...
  <form action="deleteBySender" method="post" id="delete_data">
    ...
    <div id="count"><b>보낸 메시지 수 : ${sendMessageCount}</b></div>
    ...
    <span class="date"><b>보낸 날짜</b></span><span class="read">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>받는이  읽음여부</b></span><hr>
    <c:forEach var="s" items="${sendMessageList}">
      ...
      <span class="receiver">${s.receiver_id}</span><span class="title">${s.message_title}</span><span class="date">${s.register_date}</span>
